    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('G', 'No Category'), ('F', 'Fashion'), ('U', 'Furniture'), ('P', 'Appliances')], default='G', max_length=1)),
                ('min_bid', models.DecimalField(decimal_places=0, default=0, max_digits=6, validators=[django.core.validators.MinValueValidator(1, message='Bid must be greater than $0.')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('bid', models.DecimalField(decimal_places=0, default=0, max_digits=6)),
